...
do
    ...
    function sha256(txt)
        if not bxor then error("bxor") end
        if not ror then error("bxor") end
        if not rshift then error("bxor") end
        if not band then error("bxor") end
        if not bnot then error("bxor") end
