...
List<Flavor> flavors = [
  new Flavor(
    name: "Vanilla 5.2",
    version_major: 5, version_minor: 2,
    instructions: [
      /* 0*/ new InstInfo.parse("MOVE",     "ABC",  "RR ", iBasicInst(write: [0], read: [1])),
      /* 1*/ new InstInfo.parse("LOADK",    "ABx",  "RC ", iBasicInst(write: [0], read: [1])),
      /* 2*/ new InstInfo.parse("LOADKX",   "ABx",  "R  ", iBasicInst(write: [0])),
      /* 3*/ new InstInfo.parse("LOADBOOL", "ABC",  "RLL", iBasicInst(write: [0])),
      /* 4*/ new InstInfo.parse("LOADNIL",  "ABC",  "RL ", iLoadNil),
      /* 5*/ new InstInfo.parse("GETUPVAL", "ABC",  "RU ", iBasicInst(write: [0], read: [1])),
      /* 6*/ new InstInfo.parse("GETTABUP", "ABC",  "RUT", iBasicInst(write: [0], read: [1, 2])),
      /* 7*/ new InstInfo.parse("GETTABLE", "ABC",  "RRT", iBasicInst(write: [0], read: [1, 2])),
      /* 8*/ new InstInfo.parse("SETTABUP", "ABC",  "UTT", iBasicInst(read: [0, 1, 2])),
      /* 9*/ new InstInfo.parse("SETUPVAL", "ABC",  "RU ", iBasicInst(write: [0], read: [1])),
      /*10*/ new InstInfo.parse("SETTABLE", "ABC",  "RTT", iBasicInst(read: [0, 1, 2])),
      /*11*/ new InstInfo.parse("NEWTABLE", "ABC",  "RLL", iBasicInst(write: [0])),
      /*12*/ new InstInfo.parse("SELF",     "ABC",  "RTT", iSelf),
      /*13*/ new InstInfo.parse("ADD",      "ABC",  "RTT", iBasicInst(write: [0], read: [1, 2])),
      /*14*/ new InstInfo.parse("SUB",      "ABC",  "RTT", iBasicInst(write: [0], read: [1, 2])),
      /*15*/ new InstInfo.parse("MUL",      "ABC",  "RTT", iBasicInst(write: [0], read: [1, 2])),
      /*16*/ new InstInfo.parse("DIV",      "ABC",  "RTT", iBasicInst(write: [0], read: [1, 2])),
      /*17*/ new InstInfo.parse("MOD",      "ABC",  "RTT", iBasicInst(write: [0], read: [1, 2])),
      /*18*/ new InstInfo.parse("POW",      "ABC",  "RTT", iBasicInst(write: [0], read: [1, 2])),
      /*19*/ new InstInfo.parse("UNM",      "ABC",  "RR ", iBasicInst(write: [0], read: [1])),
      /*20*/ new InstInfo.parse("NOT",      "ABC",  "RR ", iBasicInst(write: [0], read: [1])),
      /*21*/ new InstInfo.parse("LEN",      "ABC",  "RR ", iBasicInst(write: [0], read: [1])),
  ...
  new Flavor(
    ...
    instructions: [
      ...
      /*27*/ new InstInfo.parse("NOT",      "ABC",  "RR ", iBasicInst(write: [0], read: [1])),
      /*28*/ new InstInfo.parse("LEN",      "ABC",  "RR ", iBasicInst(write: [0], read: [1])),
